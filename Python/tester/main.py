...
def sa_greedy_55():
    run_program('sa_greedy_55', [program_path, 'SA', ftv55, '1', '2', '0.0001', '1', '0.995'])
...
def sa_greedy_170():
    run_program('sa_greedy_170', [program_path, 'SA', ftv170, '1', '4', '0.00001', '0.5', '0.995'])
...
def ts_greedy_55():
    run_program('ts_greedy_55', [program_path, 'TS', ftv55, '1', '2', '1000'])
...
def ts_greedy_170():
    run_program('ts_greedy_170', [program_path, 'TS', ftv170, '1', '4', '1000'])
...
def ts_greedy_358():
    run_program('ts_greedy_358', [program_path, 'TS', rbg358, '1', '6', '1000'])
